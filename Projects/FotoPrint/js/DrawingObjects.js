...
class Smile extends DrawingObjects {
    ...
    draw(cnv) {
        ...
        // hat
        ctx.beginPath();
        ctx.ellipse(this.posx, this.posy - 85, this.w / 3, 18, 0, 0, 2 * Math.PI);
        ctx.fillStyle = this.color;
        ctx.fill();
        ctx.closePath();
        ...
        ctx.beginPath();
        ctx.arc(this.posx - 10, this.posy - 15, 10, 0, 2 * Math.PI);
        ctx.fillStyle = this.color;
        ctx.fill();
        ctx.closePath();
        ctx.beginPath();
        ctx.arc(this.posx - 10, this.posy - 15, 15, 1 * Math.PI, 0);
        ctx.stroke();
        ctx.closePath();

        // left right and eyebrow
        ctx.beginPath();
        ctx.arc(this.posx + 60, this.posy - 15, 10, 0, 2 * Math.PI);
        ctx.fillStyle = this.color;
        ctx.fill();
        ctx.closePath();
        ctx.beginPath();
        ctx.arc(this.posx + 60, this.posy - 15, 15, 1 * Math.PI, 0);
        ctx.stroke();
        ctx.closePath();
        ...
        let noseOffset = 15;
        ctx.beginPath();
        ctx.moveTo(this.posx + noseOffset, this.posy + noseOffset);
        ctx.lineTo(this.posx + noseOffset + 10, this.posy + noseOffset + 20);
        ctx.lineTo(this.posx + noseOffset + 15, this.posy + noseOffset + 10);
        ctx.closePath();
        ctx.fill();
        ctx.closePath();
    ...
    mouseOver(mx, my) {
        return mx >= this.posx - this.w / 2 && mx <= this.posx + this.w / 2 && my >= this.posy - this.w / 2 && my <= this.posy + this.w / 2;
    }
}
