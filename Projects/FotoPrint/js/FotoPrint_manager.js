...
function loadInitImg() {
    ...
    let smile = new Smile(canvas.width / 2, canvas.height / 2, 100, 100, "black");

    let cenasfixes = [r, o, h, bear, ghost, smile];
...
function imageCreator(obj) {
    ...
    switch (obj.name) {
        ...
        case "G":
            ...
            break;
        case "S":
            toPut = new Smile(defaultX, defaultY, defaultSizeWH, defaultSizeWH, color.value);
            break;
        default:
